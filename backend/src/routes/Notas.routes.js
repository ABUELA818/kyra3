...
router.post("/Notas", async (req, res) => {
    try {
        // El ID del usuario y el contenido de la nota se envían en el cuerpo (body) de la solicitud
        ...
        // Envía la nota recién creada como confirmación
        res.status(201).json({ 
...
//Eliminar
router.delete("/:ID_Nota", async (req, res) => {
    try {
