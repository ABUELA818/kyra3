...
router.get("/statistics", async (req, res) => {
  try {
    ...
    // Get recent activity (last 10 assignments created)
    ...
    res.status(200).json({
      ...
      totalTeams: Number.parseInt(teamsCount.rows[0].count),
      totalProjects: Number.parseInt(projectsCount.rows[0].count),
      totalAssignments: Number.parseInt(assignmentsCount.rows[0].count),
