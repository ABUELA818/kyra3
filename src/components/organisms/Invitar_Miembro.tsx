...
export default function InvitarMiembro({ onClose, onMiembroInvitado, idEquipo, miembrosActuales }: InvitarMiembroProps) {
    ...
    <div className="invitar-miembro-overlay" onClick={onClose}>
      <div className="invitar-miembro-modal" onClick={(e) => e.stopPropagation()}>
        <div className="invitar-miembro-header">
          ...
          <button onClick={onClose} className="invitar-miembro-btn-cerrar">×</button>
        </div>
        ...
        <div className="invitar-miembro-acciones">
          <button className="invitar-miembro-btn-cancelar" onClick={onClose}>Cancelar</button>
